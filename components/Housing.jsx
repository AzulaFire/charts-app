...
const Housing = ({ fromYear, toYear }) => {
  const phoenixRent = comparisonData.city.phoenix.housing.median_home_price;
  const sapporoRent = comparisonData.city.sapporo.housing.median_home_price;
